                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-6 py-4">
                                    <span class="px-3 py-1 
                                        @if($usuario->role == 'admin') bg-red-100 text-red-700
                                        @elseif($usuario->role == 'juez') bg-purple-100 text-purple-700
                                        @elseif($usuario->role == 'asesor') bg-orange-100 text-orange-700
