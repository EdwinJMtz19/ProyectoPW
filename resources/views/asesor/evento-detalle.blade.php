    ...
    <div class="relative h-96 rounded-3xl overflow-hidden mb-8 shadow-xl">
        ...
        <div class="absolute bottom-0 left-0 right-0 p-8">
            <div class="flex gap-3 mb-4">
                ...
                @endif
                <span class="px-4 py-1.5 bg-white/90 text-gray-800 text-sm font-bold rounded-full">{{ ucfirst($evento->category) }}</span>
            </div>
                ...
                <div>
                    <div class="flex items-center gap-3 mb-4">
                        ...
                        <div>
                            ...
                            <p class="text-2xl font-bold text-gray-900">{{ $equiposCount }}</p>
                        </div>
                    </div>
