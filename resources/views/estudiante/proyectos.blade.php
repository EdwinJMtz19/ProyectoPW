                ...
                <div class="bg-white rounded-2xl shadow-sm hover:shadow-md transition-shadow border border-gray-100 overflow-hidden">
                    <div class="p-6">
                        <div class="flex items-start justify-between mb-4">
                            <div class="flex-1">
                                <h3 class="text-xl font-bold text-gray-900 mb-2 line-clamp-2">{{ $proyecto->title }}</h3>
                        ...
                        <p class="text-gray-600 text-sm mb-4 line-clamp-3">{{ $proyecto->description }}</p>
                        ...
                        <div class="space-y-2 text-sm text-gray-600 mb-4">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <span>Asesor: {{ $proyecto->advisor->name }}</span>
                            </div>
                            @endif
                            ...
                            <div class="flex items-center gap-2 text-purple-600 font-semibold">
                                ...
                                <span>{{ $proyecto->final_score }} puntos</span>
                            </div>
                            @endif
                        </div>
