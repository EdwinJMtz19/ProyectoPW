                    ...
                    <div class="p-6">
                        <div class="flex items-start justify-between mb-4">
                            <div class="flex-1">
                                <div class="flex items-center gap-3 mb-2">
                                    ...
                                    <div>
                                        <h3 class="text-xl font-bold text-gray-900"><?php echo e($equipo->name); ?></h3>
                        ...
                        <div class="space-y-2 text-sm text-gray-600 mb-4">
                            <div class="flex items-center gap-2">
                                ...
                                <span><?php echo e($equipo->members_count); ?> <?php echo e($equipo->members_count == 1 ? 'miembro' : 'miembros'); ?></span>
                            </div>
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <span><?php echo e($equipo->eventos_count); ?> <?php echo e($equipo->eventos_count == 1 ? 'evento' : 'eventos'); ?></span>
                            </div>
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <span>Líder: <?php echo e($equipo->leader->name); ?></span>
                            </div>
                        </div>
